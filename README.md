...
App desenvolvido para estudos de Flutter e Dart para praticar a criação de interface.

O app consiste em um jogo onde o lado da moeda é sorteado ao clicar no botão jogar. Logo em seguida é apresentado o resultado do sorteio. 

## Imagens

<span>
  <img src="/assets/prints/print1.png" border="1" alt="Tela inicial" max-width="200px"/>
  <img src="/assets/prints/print2.png" border="1" alt="Tela resultado" max-width="200px"/>
</span>
